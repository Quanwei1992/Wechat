...
namespace WechatTest
{
    ...
    public static class Simsimi
    {
        ...
        public static SimsimiResponse say(string word)
        {
            ...
            string url = "http://www.simsimi.com/getRealtimeReq?uuid=uNMuEpfntXvDrHDplEDqSuJcFfkQuanPVls6vaiXQtX&lc=zh&ft=1&status=W&reqText=" + word;
